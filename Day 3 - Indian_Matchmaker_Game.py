...
coffee = input("You are at a cross road. On one end you see a Starbucks and the other you see a Dunkin Donuts. Where are you going to get your coffee? Type 'S' or 'D'. ").lower()

if coffee == "s":
    activity = input("In your free time, what do you envision yourself doing? Doing yoga, mixing cocktails, traveling, or playing animal crossing? Type 'Y', 'C', 'T', or 'A'. ").lower()
    if activity == "y":
        ...
        shubha_choice = input("You were matched with your truly! But first things first, do you like dogs and is your name Gavin? Type 'Y' or 'N'. ").lower()
        if shubha_choice == "y":
    ...
    boring = input("Do you enjoy going out with your friends or staying at home and reading? Type 'O' or 'R'. ").lower()
    if boring == "o":
